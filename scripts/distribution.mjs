...
const REQUIRED_PACKAGE_FILES = [
  ...
  "modules/reconciliation-drift-detection/templates/README.md",
  "modules/reconciliation-drift-detection/templates/rules.yaml",
  "modules/reconciliation-drift-detection/templates/snapshots.md",
  "modules/gardening-entropy-management/module.yaml",
  "modules/gardening-entropy-management/templates/README.md",
  "modules/gardening-entropy-management/templates/rules.yaml",
  "modules/gardening-entropy-management/templates/snapshots.md",
