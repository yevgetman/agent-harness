...
`legibility/`, `reports/`, `reconciliation/`, and `modules/`. The
...
`capture/`, `decisions/`, `legibility/`, `memory/`, `metadata/`, `plans/`,
`reports/`, `reconciliation/`, `state/`, `status.md`, and test fixtures is
